...
`RM' merlin_p_userh_logh(`gml' gml, | `RC' t)
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)

	return(log((*gml.Puserst[gml.model,1])(gml,t)))
}
...
{	
	...
	return((*gml.Puserst[gml.model,1])(gml,t))
}
...
`RM' merlin_p_userh_dens(`gml' gml, | `RC' t)
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)
	return(merlin_p_userh_h(gml,t):*exp(-merlin_p_userh_ch(gml,t)))
}
...
{	
	...
	return(exp((*gml.Puserst[gml.model,2])(gml,t)))
}

`RM' merlin_p_userlogh_logh(`gml' gml, | `RC' t)
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)

	return((*gml.Puserst[gml.model,2])(gml,t))
}
...
`RM' merlin_p_userlogh_dens(`gml' gml, | `RC' t)
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)
	return(merlin_p_userlogh_h(gml,t):*exp(-merlin_p_userlogh_ch(gml,t)))
}
...
`RM' merlin_p_userhch_logh(`gml' gml, | `RC' t)
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)
	return(log((*gml.Puserst[gml.model,1])(gml,t)))
...
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)
	return((*gml.Puserst[gml.model,3])(gml,t))
}
...
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)
	return(log((*gml.Puserst[gml.model,3])(gml,t)))
}
...
`RM' merlin_p_userhch_dens(`gml' gml, | `RC' t)
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)
	return(merlin_p_userhch_h(gml,t):*exp(-merlin_p_userhch_ch(gml,t)))
}
...
`RM' merlin_p_userloghch_logh(`gml' gml, | `RC' t)
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)
	return((*gml.Puserst[gml.model,2])(gml,t))
...
`RM' merlin_p_userloghch_dens(`gml' gml, | `RC' t)
{	
	not = args()==1
	if (not) t = merlin_util_timevar(gml)
	return(merlin_p_userloghch_h(gml,t):*exp(-merlin_p_userloghch_ch(gml,t)))
}
